...
const EXPECTED_COLUMNS = {
  ...
  ai_model_families: ['id', 'container_id', 'name', 'cost_tier', 'cap_chat', 'cap_jobs', 'cap_planning', 'cap_coding', 'cap_summary', 'eligible_tasks'],
  ...
  routing_cascade: ['id', 'task_type', 'priority', 'family_id', 'access_method', 'enabled'],
